...
export default function AttendeeDetails({ attendee, conference, status }: Props) {
    const handleRejectSpealer = async () => {
    ...
    const handleAcceptSpealer = async () => {
        // const request = await fetch(`http://localhost:3000/speaker-applications/${_id}/review`, {
        //     method: "POST",
        //     headers: {
        //         "Content-Type": "application/json",
